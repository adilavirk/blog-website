...
const Footer = () => {
  ...
  console.log(errors);
  return (
    <footer className="top-16 rounded-2xl bg-dark dark:bg-accentDark/90 m-2 sm:m-10 flex flex-col items-center text-light dark:text-dark">
      ...
      <div className="flex items-center mt-8">
        {/*we are using here external links therefor we are not using Link element from next js here */}
      ...
      {/* copyright */}
      <div className="w-full sm:mt-16 md:mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex-col flex md:flex-row items-center justify-between">
